---
title: "In-class Exercise 4: Geographically Weighted Regression"
editor: visual
---

# Lesson 4: Geographically Weighted Regression (GWR)

Review of Chapter 6: Calibrating Hedonic Pricing Model for Private Highrise Property with GWR Method
...
-   For 1 year age increase, price falls by \$24,687.

-   For PROX_PRIMARY_SCH, per 1 unit of distance, price increased by \$159,856. Does it really make sense in actual fact?

-   Note: +/- sign to do a sense check

**Note:**

-   R-squared for single linear regression

-   Adj. R-squared for multivariable linear regression
...
In the code chunk below, the [`ols_vif_tol()`](https://olsrr.rsquaredacademy.com/reference/ols_coll_diag.html) of **olsrr** package is used to test if there are sign of multicolinearity.
...
-   **Quiz: Do you know why it is in metre?** This is because we have transformed the dataframe to EPSG 3414 (Singapore) in which metre is the unit of length.
...
The result shows that the 30 is the recommended data points to be used **(i.e. stopping point of data for Adaptive Bandwidth above).**
