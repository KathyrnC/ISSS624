...
![](images/paste-B0449DD8.png)Using the code chunk below, we will now delete the "ADM2_EN' field.
...
![](images/paste-6C0C315A.png)Notice that the values range of the Min-max standardised clustering variables are 0 to 1 now.
...
![](images/paste-408A5AE5.png)![](images/paste-7D337F56.png)![](images/paste-094922D1.png)Notice the mean and standard deviation of the Z-score standardized clustering variables are 0 and 1 respectively.
...
![](images/paste-1AB10B11.png)Next, we can visualise the plot by using [*fviz_gap_stat()*](https://rpkgs.datanovia.com/factoextra/reference/fviz_nbclust.html) of [**factoextra**](https://rpkgs.datanovia.com/factoextra/) package.
...
![](images/paste-E2FC8D1B.png)From the choropleth map, we can see that the clusters are very fragmented. This may be due to limitations of non-spatial clustering algorithm like hierarchical clustering analysis.
...
### ![](images/paste-1252D013.png)Spatially Constrained Hierarchical Clustering
...
![](images/paste-0D086F72.png)![](images/paste-7E30D254.png)Based on the results shown above, we will use an alpha value of 0.1.
